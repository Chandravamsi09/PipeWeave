"""
PipeWeave Streaming Connector Adapter: Instance 22
...
logger = logging.getLogger("pipeweave.connectors.connector_stream_adapter_22")

class ConnectorAdapter22(BaseSourceConnector):
    """Adapter implementation 22."""
    ...
    async def read_batch(self, limit: Optional[int] = None) -> RecordBatch:
        ...
        records = [{"id": idx, "adapter": "connector_stream_adapter_22", "value": idx * 10.5} for idx in range(1, cnt + 1)]
        return RecordBatch(records=records)

    async def discover_schema(self) -> Dict[str, Any]:
        return {"adapter": "connector_stream_adapter_22", "type": "STREAMING"}
