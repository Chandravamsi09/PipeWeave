"""
PipeWeave Streaming Connector Adapter: Instance 21
...
logger = logging.getLogger("pipeweave.connectors.connector_stream_adapter_21")

class ConnectorAdapter21(BaseSourceConnector):
    """Adapter implementation 21."""
    ...
    async def read_batch(self, limit: Optional[int] = None) -> RecordBatch:
        ...
        records = [{"id": idx, "adapter": "connector_stream_adapter_21", "value": idx * 10.5} for idx in range(1, cnt + 1)]
        return RecordBatch(records=records)

    async def discover_schema(self) -> Dict[str, Any]:
        return {"adapter": "connector_stream_adapter_21", "type": "STREAMING"}
