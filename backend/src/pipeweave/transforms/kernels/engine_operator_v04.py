"""
PipeWeave Vectorized Engine Operator: Module 04
...
logger = logging.getLogger("pipeweave.engine.engine_operator_v04")

class OperatorKernel04:
    """Kernel implementation for operator 04."""
    def __init__(self, operator_id: str = "op_04", parallelism: int = 8):
